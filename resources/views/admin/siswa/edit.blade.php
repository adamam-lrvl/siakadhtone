    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-indigo-600 to-purple-700 px-6 py-5 text-white">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-xl font-bold">Edit Siswa</h2>
                    <p class="text-indigo-100 text-sm opacity-90">Perbarui data {{ $siswa->nama }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-5 md:p-7">
            ...
            <form action="{{ route('admin.siswa.update', $siswa) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <!-- NIS -->
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">NIS</label>
                    ...
                    <div>
                        ...
                        <input type="text" name="telepon_wali" value="{{ old('telepon_wali', $siswa->telepon_wali) }}"
                            class="w-full px-4 py-2.5 text-sm border rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="alamat" rows="3"
                            class="w-full px-4 py-2.5 text-sm border rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">{{ old('alamat', $siswa->alamat) }}</textarea>
                    </div>
