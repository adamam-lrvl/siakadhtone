{{-- resources/views/admin/soal/create.blade.php --}}
{{-- FINAL VERSION — JALAN 100% + TAMPILAN INDIGO-PURPLE EMPIRE LEVEL DEWA! --}}
@extends('admin.layouts.admin')
@section('title', 'Buat Paket Soal CBT')
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-indigo-600 to-purple-700 px-6 py-5 text-white">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-2xl font-bold">Buat Paket Soal CBT</h2>
                    <p class="text-indigo-100 text-sm opacity-90">Lengkapi informasi paket dan tambahkan soal-soal</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 md:p-8">
            ...
            <form action="{{ route('admin.soal.store') }}" method="POST">
                ...
                <!-- INFORMASI PAKET — INDIGO PURPLE STYLE -->
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="judul" value="{{ old('judul') }}" required
                                   ...
                                   placeholder="Contoh: Ulangan Harian Matematika Kelas XII">
                        </div>

                        <div>
                            <label class="block text-xs font-semibold text-gray-700 mb-1.5">Mata Pelajaran <span class="text-red-500">*</span></label>
                            <select name="mapel_id" required
                                    class="w-full px-4 py-2.5 text-sm border rounded-xl focus:ring-2 focus:ring-indigo-500 @error('mapel_id') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <select name="kelas_id" required
                                    class="w-full px-4 py-2.5 text-sm border rounded-xl focus:ring-2 focus:ring-indigo-500 @error('kelas_id') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="number" name="durasi" value="{{ old('durasi', 60) }}" min="10" required
                ...
                <!-- DAFTAR SOAL — MENGGUNAKAN SCRIPT LU YANG SUDAH 100% JALAN! -->
                <div class="mb-8">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <!-- TOMBOL TAMBAH SOAL — PAKE onclick SEPERTI KODE LU YANG UDAH JALAN! -->
...
{{-- SCRIPT LU YANG UDAH 100% JALAN — GUE GAK UBAH SAMA SEKALI! --}}
<script>
let soalIndex = 0;
        ...
        <div class="space-y-5">
            ...
            <div class="pilihan-container space-y-3" style="${tipe === 'essay' ? 'display:none' : ''}">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <input type="text" name="soal[${soalIndex}][pilihan][${i}]"
                ...
                <div class="mt-4">
                    ...
                    <select name="soal[${soalIndex}][jawaban]" required
                            class="w-full px-4 py-2.5 text-sm border rounded-xl focus:ring-2 focus:ring-indigo-500">
...
// INI YANG BIKIN JALAN DARI AWAL — GAK DIUBAH SAMA SEKALI!
