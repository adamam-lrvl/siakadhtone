...
<div class="max-w-2xl mx-auto px-4 py-6 space-y-6">
    ...
    <div class="relative rounded-2xl overflow-hidden
        ...
        <div class="relative p-6 flex items-center gap-3">
            ...
            <div>
                <h1 class="text-xl font-extrabold text-white tracking-tight">Tambah kelas baru</h1>
                <p class="text-blue-200 dark:text-white/40 text-sm mt-0.5">Isi data kelas dengan lengkap</p>
            </div>
        </div>
    </div>
