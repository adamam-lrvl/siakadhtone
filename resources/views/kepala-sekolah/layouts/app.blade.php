        ...
        <nav class="flex-1 overflow-y-auto no-scrollbar px-3 py-4 space-y-0.5">
            ...
            <a href="{{ route('kepsek.pengumuman.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition
                ...
                @if($pendingCount > 0)
                    <span class="ml-auto bg-amber-500 text-white text-xs font-bold
            ...
            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider px-3 pt-4 mb-2">Sistem</p>
...
{{-- ✅ STACK SCRIPTS DULU sebelum DOMContentLoaded --}}
@stack('scripts')
