    ...
    <div class="relative z-10 flex w-full min-h-screen">
        ...
        <div class="hidden lg:flex lg:w-1/2 flex-col items-center justify-center p-14 text-white">
            <div class="max-w-sm w-full">
                ...
                <div class="space-y-3">
                    @foreach([
                        ['shield-check', 'Buat password baru', 'Gunakan kombinasi huruf, angka, dan simbol'],
                        ['lock',  'Minimal 8 karakter',  'Semakin panjang, semakin aman'],
                        ['check-circle',  'Konfirmasi ulang',  'Pastikan kedua password sama persis'],
                    ] as [$icon, $title, $desc])
        ...
        <div class="flex-1 flex flex-col items-center justify-center px-6 py-12">
            ...
            <div class="glass-card rounded-3xl p-8 w-full max-w-sm">
                ...
                {{-- JUDUL --}}
                <div class="mb-7">
                    <h2 class="text-2xl font-extrabold text-white tracking-tight">Buat password baru</h2>
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="{{ old('email', request()->email) }}"
                                   required readonly
                                   class="glass-input w-full pl-10 pr-4 py-2.5 rounded-xl text-sm opacity-70">
                        </div>
                    </div>
                    ...
                    {{-- SUBMIT --}}
                    <button type="submit"
                            class="glass-btn w-full py-3 rounded-2xl text-sm mt-1 flex items-center justify-center gap-2">
